...
const authCardOuterVariants = cva(
  "bg-white shadow-login-card",
  {
    variants: {
      size: {
...
interface AuthCardProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof authCardOuterVariants> {}
...
function AuthCardLogo({
  ...
  return (
    <div
      data-slot="auth-card-logo"
      className={cn(authCardLogoVariants(), className)}
      {...props}
    >
      {children}
    </div>
...
function AuthCardDescription({
  ...
  return (
    <p
      ...
      className={cn(
        "text-[18px] font-medium leading-normal text-login-subtitle",
        className
      )}
      {...props}
    />
...
function AuthCardFooter({
  ...
  return (
    <p
      ...
      className={cn(
        "text-center text-[18px] leading-normal text-login-footer",
        className
      )}
      {...props}
    />
...
function AuthCardDivider({
  ...
  return (
    ...
    >
      ...
      <span className="text-base font-medium text-login-separator">
        {children}
      </span>
      <div className="h-px flex-1 bg-login-separator" />
    </div>
