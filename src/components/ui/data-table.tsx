...
function DataTableHeader({
  ...
  return (
    <div
      ...
      className={cn(
        "flex h-[73px] items-center gap-[79px] px-[18px]",
        className
      )}
      {...props}
    >
...
interface ProductThumbnailProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof productThumbnailVariants> {
  src?: string
  alt?: string
}
...
const productNameVariants = cva(
  "m-0 truncate font-heading text-base font-bold leading-none",
  {
    variants: {
      variant: {
        default: "text-[#161919]",
...
const tableCellCheckboxVariants = cva(
  "size-[22px] shrink-0 rounded border",
  {
    variants: {
      checked: {
...
interface TableCellCheckboxProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof tableCellCheckboxVariants> {}
...
const actionBadgeVariants = cva(
  "flex items-center justify-center rounded-[23px] p-1",
  {
    variants: {
      variant: {
...
interface ActionBadgeProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof actionBadgeVariants> {}
...
function RowActions({
  ...
  return (
    <div
      ...
      className={cn(
        "flex w-[133px] shrink-0 items-center justify-center gap-8",
        className
      )}
      {...props}
    >
